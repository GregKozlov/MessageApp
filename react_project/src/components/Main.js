    ...
    return (
        <div className="row">
            <div className="col-12">
                ...
                <div className="text">
                    <p><b>ShareNotes</b> – сервис для обмена заметками. Создайте заметку, отправьте ссылку на заметку и ваш друг сможет ее просмотреть. Через некоторое время заметка будет удалена.</p>
